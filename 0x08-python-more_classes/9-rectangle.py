...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Args:
            rect_1 (:obj: Rectangle): The first Rectangle object to compare.
            rect_2 (:obj: Rectangle): The second Rectangle object to compare.

        Return:
            The biggest rectangle. if equal the first rectangle.
        """
    ...
    def square(cls, size=0):
        """square : class method
        This method creates a rectangle object with size is both the height
        and the width.
